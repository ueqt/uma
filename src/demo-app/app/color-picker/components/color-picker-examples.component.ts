...
import { UmaColorPickerItem, UmaColorPickerService } from '../../../../lib/color-picker';
...
export class ColorPickerExamplesComponent implements OnInit {
  ...
  constructor(
    ...
    private umaColorPickerService: UmaColorPickerService
  ) { }
  ...
  reset(): void {
    this.umaColorPickerService.resetUseColors();
  }
