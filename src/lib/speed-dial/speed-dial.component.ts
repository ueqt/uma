...
@Component({
  selector: 'uma-speed-dial',
  templateUrl: './speed-dial.component.html',
  styleUrls: ['./speed-dial.component.scss'],
  animations: [SPIN_ANIMATION],
})
export class UmaSpeedDialComponent implements AfterViewInit, OnChanges {
  /**
   * Hold speed-dial-actions component inside this component
   */
  @ContentChild(UmaSpeedDialActionsComponent) actions: UmaSpeedDialActionsComponent;
