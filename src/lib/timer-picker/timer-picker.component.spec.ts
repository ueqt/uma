...
import { UmaTimerPickerComponent } from '../../../src/lib/timer-picker/timer-picker.component';

describe('UmaTimerPickerComponent', () => {
  let comp: UmaTimerPickerComponent;
  let fixture: ComponentFixture<UmaTimerPickerComponent>;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [PortalModule, OverlayModule],
      declarations: [UmaTimerPickerComponent],
      providers: [
        { provide: ComponentFixtureAutoDetect, useValue: true }
      ]
    });

    TestBed.overrideComponent(UmaTimerPickerComponent, {
      set: {
        changeDetection: ChangeDetectionStrategy.Default
      }
    });

    fixture = TestBed.createComponent(UmaTimerPickerComponent);
  ...
  it('should hide buttons', () => {
    ...
    const actions = fixture.nativeElement.querySelector('.uma-timer-picker-actions');
  ...
  it('should emit time with hide buttons', () => {
    ...
    const btnPeriod = fixture.debugElement.queryAll(By.css('.uma-timer-picker-am-pm button'))[1];
