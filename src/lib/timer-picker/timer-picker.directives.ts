...
@Directive({
  selector: '[umaTimerPickerOrigin], [uma-timer-picker-origin]',
  exportAs: 'umaTimerPickerOrigin',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => UmaTimerPickerOriginDirective),
      multi: true,
    },
  ],
})
export class UmaTimerPickerOriginDirective {
  /**
...
@Directive({
  selector: '[umaConnectedTimerPicker], [uma-connected-timer-picker]',
  exportAs: 'umaConnectedTimerPicker',
})
export class UmaConnectedTimerPickerDirective implements AfterViewInit, OnDestroy {
  /**
   * origin of the connected timer picker
   */
  @Input('umaConnectedTimerPickerOrigin') origin: UmaTimerPickerOriginDirective;
  ...
  constructor(
    private timerPicker: UmaTimerPickerComponent,
