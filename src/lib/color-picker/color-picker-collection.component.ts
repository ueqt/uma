...
import { EMPTY_COLOR, UmaColorPickerOption } from './color-picker';

@Component({
  selector: 'uma-color-picker-collection',
  templateUrl: './color-picker-collection.component.html',
  styleUrls: ['./color-picker-collection.component.scss'],
  preserveWhitespaces: false,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UmaColorPickerCollectionComponent implements AfterContentChecked {
  /**
   * Hide empty slots
   ...
   */
  @Input()
  get colors(): UmaColorPickerOption[] {
    return this._colors;
  }
  set colors(values: UmaColorPickerOption[]) {
    this._colors = values;
  }
  private _colors: UmaColorPickerOption[];
  ...
  /**
   * Emit selected color value
   * @param option UmaColorPickerOption
   */
  setColor(option: UmaColorPickerOption) {
