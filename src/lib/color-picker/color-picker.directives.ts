...
import { EMPTY_COLOR, coerceHexaColor, isValidColor, UmaColorPickerOption } from './color-picker';
 ...
 */
@Directive({
  selector: '[umaColorPickerOption], [uma-color-picker-option]',
  exportAs: 'umaColorPickerOption',
})
export class UmaColorPickerOptionDirective implements AfterViewInit {
  /**
   * Receive the color
   */
  @Input('umaColorPickerOption')
  get color(): UmaColorPickerOption {
    return this._color;
  }
  set color(value: UmaColorPickerOption) {
    this._color = value;
  }
  private _color: UmaColorPickerOption;
 ...
 */
@Directive({
  selector: '[uma-color-picker-origin], [umaColorPickerOrigin]',
  exportAs: 'umaColorPickerOrigin',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => UmaColorPickerOriginDirective),
      multi: true,
    },
  ],
})
export class UmaColorPickerOriginDirective implements ControlValueAccessor {
  /**
 ...
 */
@Directive({
  selector: '[uma-connected-color-picker], [umaConnectedColorPicker]',
  exportAs: 'umaConnectedColorPicker',
})
export class UmaConnectedColorPickerDirective implements AfterViewInit, OnDestroy {
  /**
   * Origin of the connected color picker
   */
  @Input('umaConnectedColorPickerOrigin') origin: UmaColorPickerOriginDirective;
  ...
  constructor(
    private colorPicker: UmaColorPickerComponent,
