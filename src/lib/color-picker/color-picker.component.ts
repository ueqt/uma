...
@Component({
  selector: 'uma-color-picker',
  templateUrl: './color-picker.component.html',
  styleUrls: ['./color-picker.component.scss'],
  preserveWhitespaces: false,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UmaColorPickerComponent implements AfterContentInit, OnInit, OnDestroy {
  /**
   * Get all collections
   */
  @ContentChildren(UmaColorPickerCollectionComponent)
  _collections: QueryList<UmaColorPickerCollectionComponent>;
  ...
  constructor(
    ...
    private colorPickerService: UmaColorPickerService,
  ...
  ngAfterContentInit() {
    if (this._collections) {
      this._collections.forEach((collection: UmaColorPickerCollectionComponent) => {
